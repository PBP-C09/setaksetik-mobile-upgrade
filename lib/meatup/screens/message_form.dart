...
class _MessageFormPageState extends State<MessageFormPage> {
  ...
  Future<void> fetchReceivers() async {
    ...
    try {
      final response = await request.get('https://haliza-nafiah-setaksetik.pbp.cs.ui.ac.id/meatup/flutter/get-receivers/');
      if (mounted) {
        setState(() {
                              ...
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  String url = widget.messageToEdit != null
                                      ? 'https://haliza-nafiah-setaksetik.pbp.cs.ui.ac.id/meatup/flutter/edit/${widget.messageToEdit!['id']}/'
                                      : 'https://haliza-nafiah-setaksetik.pbp.cs.ui.ac.id/meatup/create-flutter/';
